...
impl Robot {
    fn from_line(line: &str) -> Self {
        ...
        let (xv, yv) = (xv.to_i(), yv.to_i());

        Self { x, y, xv, yv }
    }

    fn move0(&mut self, w: usize, h: usize) {
        let (w, h) = (w as i32, h as i32);
        let mut nx = self.x as i32 + self.xv;
        let mut ny = self.y as i32 + self.yv;
...
mod tests {
    ...
    #[test]
    fn test_p1_sample() {
        assert_eq!(12, p1(SAMPLE, 11, 7));
    }

    #[test]
    fn test_p1_in() {
        assert_eq!(221616000, p1(IN, 101, 103));
    }
...
pub static SAMPLE: &str = "p=0,4 v=3,-3
p=6,3 v=-1,-3
p=10,3 v=-1,2
p=2,0 v=2,-1
p=0,0 v=1,3
...
pub static IN: &str = "p=62,65 v=-96,-93
p=50,44 v=72,74
p=33,42 v=-6,-83
p=68,100 v=36,21
p=45,36 v=3,-44
